...
const ANTI_CHICKEN_HANDWRITTEN = [
  "失败是成功之母，但成功不孕不育。",
  "努力不一定成功，但不努力一定很轻松。",
...
const ANTI_TEMPLATES = [
  "{verb}就{result}——{negation}",
  "只要{condition}，就一定能{goal}——前提是{prerequisite}",
  "{saying}——{reversal}",
  "记住：{advice}。但{reality}",
  "你{positive}，只是{negative}",
  "别人{action}的时候，你{reaction}——这就是区别。区别在于{difference}",
  "{encouragement}——{disclaimer}",
  "有{thing}就有一切——可惜你没有{thing}",
  "{promise}——{truth}",
  "每个人都是{compliment}——只是{insult}",
  "{wise}——说这话的人{reveal}",
  "{affirmation}——{doubt}",
  "{rule}——{exception}",
  "相信自己，{motivation}——{demotivation}",
  "{philosophy}——{counter_philosophy}",
];

const ANTI_FILL = {
  verb: ["坚持","努力","奋斗","拼搏","加油","微笑","前进","奔跑","追求","突破","改变","尝试","学习","付出","等待","坚持","出发"],
  result: ["会成功的","会有回报的","就能到达终点","就能看到曙光","就能实现梦想","就是胜利","就离目标更近了","就能改变命运","就会有奇迹","就赢了"],
  negation: ["才怪","并不","想多了","做梦","假的不行","概率为零","已经被证明是假的","研究表示并非如此","这句话只对1%的人有效","你信了吗","前提是运气好","但统计不站你这边"],
  condition: ["坚持下去","不放弃","相信自己","足够努力","心态好","敢想敢做","保持热情","不断学习","心存善念","早起","多读书","有梦想","足够优秀"],
  goal: ["成功","逆袭","暴富","脱单","升职","实现梦想","改变命运","成为想成为的人","得到想要的","到达彼岸","发光","翻盘"],
  prerequisite: ["你首先得有运气","你的背景得够硬","你得先投个好胎","你得先不被生活打趴下","你得住在北京三环内","你得先有个有钱的爹","你得先活到那一天","这个前提不存在","你做梦的时候可以","你的定义得够宽"],
  saying: ["天道酬勤","车到山前必有路","柳暗花明又一村","船到桥头自然直","是金子总会发光","上帝为你关了一扇门就会打开一扇窗","苦尽甘来","否极泰来","有志者事竟成","功夫不负有心人","不经历风雨怎么见彩虹","吃得苦中苦方为人上人","塞翁失马焉知非福","宝剑锋从磨砺出","梅花香自苦寒来"],
  reversal: ["但天也酬懒","但路可能是死路","但下一村可能更暗","但桥头可能没水","但大部分人是石头","但窗户被焊死了","但甘来之前你已经苦死了","但否可能极到极点","但志可能不够大","但功夫也可能负你","但有些人就是淋雨的命","但苦中苦吃完可能还是苦","但塞翁的马可能真丢了","但宝剑可能磨断了","但梅花可能冻死了"],
  advice: ["做自己","往前走","别回头","坚持就是胜利","微笑面对生活","永远不要放弃","保持热爱","相信过程","追随内心","勇往直前"],
  reality: ["做自己需要先找到自己","往前走可能是在绕圈","别回头是因为后面没什么可看的","坚持也可能是白费力气","微笑面对但嘴角已经抽筋了","永远不要放弃你的放弃权利","保持热爱但钱包不允许","相信过程但结果不一定信你","追随内心但内心在说想躺平","勇往直前但前面是墙"],
  positive: ["很特别","有潜力","值得被爱","足够好","很有才华","很努力","很优秀","很勇敢","很有魅力","很聪明"],
  negative: ["特别穷而已","潜力兑现需要手续费","值不值得得看市场价","好到没人发现","才华还没找到出口","努力的方向不太对","优秀得不太明显","勇敢到有点莽","魅力需要先过美颜这关","聪明得不太够用"],
  action: ["奔跑","坚持","努力","奋斗","拼搏","加班","学习","付出","追梦","早起"],
  reaction: ["躺着","放弃","划水","摆烂","摸鱼","迟到","刷手机","发呆","等风来","假装没醒"],
  difference: ["你穷","你累","你懒","你菜","你怂","你还没找到方向","你的起点是别人的终点","你少了个好爹","你选了困难模式","你可能只是NPC"],
  encouragement: ["加油","你一定行的","未来可期","一切都会好的","相信自己","明天会更好","越努力越幸运","你是最棒的","风雨过后是彩虹","柳暗花明"],
  disclaimer: ["但油可能加不起","行不行得看行规","可期是多久呢","好到什么程度呢","信不信由你吧","好到什么时候呢","幸不幸运跟努不努力没关系","棒不棒得看跟谁比","彩虹也可能是幻觉","也可能柳更暗花更枯"],
  thing: ["梦想","希望","信念","勇气","知识","爱","健康","时间","信心","坚持"],
  promise: ["付出总有回报","一分耕耘一分收获","好人有好报","苦尽甘来","风雨之后见彩虹","天生我材必有用","只要坚持就能成功","你的努力不会白费","机会是留给有准备的人","一切都是最好的安排"],
  truth: ["回报可能不是你想要的那种","但收获的可能只有教训","好报可能在下辈子","但甘可能来得很晚","也可能只有风雨没有彩虹","但用不用得上另说","成功也需要运气成分","白费不白费你自己说了不算","准备的人多了去了机会就一个","最坏的安排也是安排"],
  compliment: ["独一无二的","被需要的","特别的","有价值的","闪耀的","不可替代的","充满可能的","美丽的","有力量的","值得的"],
  insult: ["独一无二地穷","被需要的时候不多","特别地普通","有价值但没市场价","闪耀得没人看见","可替代性极强","可能性约等于零","美丽但需要滤镜","力量仅限于搬砖","值得但没人买单"],
  wise: ["人生没有白走的路","一切都是最好的安排","命运掌握在自己手中","机会只留给有准备的人","吃得苦中苦方为人上人","你只管努力剩下的交给时间","所有的失去都会以另一种方式归来","上帝为你关上一扇门就会打开一扇窗","人生没有过不去的坎","阳光总在风雨后"],
  reveal: ["自己走了很多冤枉路","安排你的人可能搞错了","手可能握不住","准备的人太多了不够分","但人上人可能不吃苦","时间说：你交给我的我可没答应收","但归来的可能是账单","但可能打开的是地狱之门","但有些坎就是过不去","但风雨后可能还是风雨"],
  affirmation: ["你可以的","你值得","你能行","你会成功的","你很厉害","你是被选中的","你天生就是做这个的","你与众不同","你会找到出路的","你配得上更好的"],
  doubt: ["但你确定吗？","值不值市场说了算","行不行试试才知道","成不成功概率说了算","厉不厉害对比才知道","被选中干嘛的","但天生不代表擅长","与众不同的方式可能不太好","出路可能绕路很远","更好的也配不上你"],
  rule: ["付出就有回报","努力就能成功","善有善报","吃亏是福","吃得苦中苦方为人上人","有志者事竟成","勤能补拙","坚持到底就是胜利","知识改变命运","机会留给有准备的人"],
  exception: ["但回报可能不对等","但成功也需要运气","但善报可能要等几辈子","但福都让别人享了","但人上人可能不吃苦","但志向可能不够大","但勤可能补不了太多","但到底可能只是到底了","但知识可能只改变认知","但准备的人太多了机会不够分"],
  motivation: ["你一定能做到","没有什么是不可能的","全世界都会为你让路","你的努力终将被看见","属于你的终究会来","风雨之后必见彩虹"],
  demotivation: ["但做到的程度另说","不可能的事多了去了","路可能被堵了","被看见不等于被认可","来是来了但可能迟到","也可能只有风雨"],
  philosophy: ["活着就是希望","人生苦短及时行乐","你只活一次","活在当下","一切都是最好的安排","一切都是浮云"],
  counter_philosophy: ["但希望可能就是活着本身","行乐需要钱","所以别太折腾","当下可能很惨","安排你的人可能不太行","但浮云也需要阳光"],
};

// 生成反鸡汤池：手写 + 模板
const ANTI_CHICKEN_SOUP = [...ANTI_CHICKEN_HANDWRITTEN];

(function generateAntiChickens() {
  const used = new Set(ANTI_CHICKEN_HANDWRITTEN);
  let attempts = 0;
  while (ANTI_CHICKEN_SOUP.length < 1200 && attempts < 5000) {
    attempts++;
    const tpl = ANTI_TEMPLATES[Math.floor(Math.random() * ANTI_TEMPLATES.length)];
    const text = tpl.replace(/\{(\w+)\}/g, (_, key) => {
      const pool = ANTI_FILL[key];
      return pool ? pool[Math.floor(Math.random() * pool.length)] : "???";
    });
    if (!used.has(text)) {
      used.add(text);
      ANTI_CHICKEN_SOUP.push(text);
    }
  }
})();
